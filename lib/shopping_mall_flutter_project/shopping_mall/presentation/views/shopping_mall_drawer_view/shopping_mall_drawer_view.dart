...
class ShoppingMallDrawerView extends StatelessWidget {
  const ShoppingMallDrawerView({Key? key}) : super(key: key);
        ...
        children: [
          ...
          Row(
            children: [
              Container(
                height: 1,
                width: deviceWidth * (250 / 360) * (210 / 250),
                color: Colors.grey,
              ),
            ],
          )
